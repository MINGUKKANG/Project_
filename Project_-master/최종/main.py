...
DEFINE_integer("n_epoch", 40, "number of Epoch for training")
...
DEFINE_float("lr", 0.0012, "learning rate for GAN training")
...
DEFINE_float("gamma", 1.0, "Hyper parameter of BEGAN")
DEFINE_float("lamda", 0.003, "Hyper parameter of BEGAN")
