...
class data_controller:
    ...
    def preprocessing(self):
        ...
        for i in range(len(self.test_labels)):
            if self.test_labels[i] in self.normal:
                self.test_bi_labels.append(0)
            else:
                self.test_bi_labels.append(1)
        print("Train_Data_mean: ", training_mean)
        print("Test_Data_mean: ", testing_mean)

        return self.train_images, self.train_labels, self.test_images, self.test_labels, self.test_bi_labels
